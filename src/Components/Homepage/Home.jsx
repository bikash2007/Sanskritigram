  ...
  return (
      <div className='w-full h-screen flex gap-10 justify-center text-white items-center '>
          {websites.map((items) => (
              ...
              <a href='https://hansadhwani.sanskritigram.org/' target='_main' className='h-96 w-72 relative rounded-lg flex items-end hover:scale-105 duration-200 active:scale-95 ' style={{background:`url(${items.photo})`,backgroundPosition:'center',backgroundSize:'cover'}}>
                    <div className='p-2'>
